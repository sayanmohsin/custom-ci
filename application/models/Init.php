...
class Init extends CI_Model {
    ...
    // function dbCustom () {
      ...
      // try {
          // $data["con"] = new PDO("mysql:host=$hostname;dbname=$database", $username, $password);
          // $data["con"]->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          // return $data;
          // }
